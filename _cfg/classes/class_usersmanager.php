 ...
 */
     ...
     * @param Users $user
     */
    public function update(Users $user, $oldusername)
    {
        try{
            $user->setName(strtoupper($user->getName()));
            if(!empty($user->getPassword())){
                $q = $this->_db->prepare("UPDATE users SET username = :username, name = :name, firstname = :firstname, emailAddress = :emailAddress, password = :password, phoneNumber = :phoneNumber, isActive = :isActive  WHERE username = '$oldusername'");
                $q->bindValue(':username', $user->getUsername(), PDO::PARAM_STR);
                $q->bindValue(':name', $user->getName(), PDO::PARAM_STR);
                $q->bindValue(':firstname', $user->getFirstName(), PDO::PARAM_STR);
                $q->bindValue(':emailAddress', $user->getEmailAddress(), PDO::PARAM_STR);
                ...
                $q = $this->_db->prepare("UPDATE users SET username = :username, name = :name, firstname = :firstname, emailAddress = :emailAddress, phoneNumber = :phoneNumber, isActive = :isActive  WHERE username = '$oldusername'");
                $q->bindValue(':username', $user->getUsername(), PDO::PARAM_STR);
                $q->bindValue(':name', $user->getName(), PDO::PARAM_STR);
                $q->bindValue(':firstname', $user->getFirstName(), PDO::PARAM_STR);
                $q->bindValue(':emailAddress', $user->getEmailAddress(), PDO::PARAM_STR);
