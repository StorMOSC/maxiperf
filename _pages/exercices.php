...
<script>
    $(document).ready(function() {
        ...
        $('#ajout_serie').click(function(){
            ...
            var commentaire_parcours_input = document.getElementById("commentaire").value;
        ...
        $('#ajouter').click(function(){
            ...
            console.log('Test input : '+commentaire_parcours_input);
            ...
            if(jsonParcours.hasOwnProperty('nom')){
                ...
                jsonParcours = {
                    "nom":nom_parcours,
                    "date":date_parcours,
                    "commentaire":commentaire_parcours_input,
